...
(**
 * {2 Values represented with handles.}
 *)
...
(**
 * {2 Update the environment with a result.}
 *)
...
(************************************************************************
 * {2 For squashing (producing digests).}
 *)
